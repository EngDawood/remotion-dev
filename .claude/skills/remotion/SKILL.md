...
Load the [./rules/audio-visualization.md](./rules/audio-visualization.md) file for more information.

## Sound effects

Load the [./rules/sfx.md](./rules/sfx.md) file for more information.
...
See [rules/google-fonts.md](rules/google-fonts.md) for how to load Google Fonts.
...
See [rules/html-in-canvas.md](rules/html-in-canvas.md) for rendering HTML into a `<canvas>`.
...
See [rules/measuring-text.md](rules/measuring-text.md) for measuring text dimensions.

## Advanced sequencing

See [rules/sequencing.md](rules/sequencing.md) for more sequencing patterns.
...
See [rules/trimming.md](rules/trimming.md) for trimming patterns.

## Advanced Videos

See [rules/videos.md](rules/videos.md) for advanced knowledge about embedding videos.
